...
<template>
  <aside class="sticky top-0 hidden h-screen w-72 shrink-0 border-r border-slate-200 bg-white/88 p-4 backdrop-blur-xl dark:border-slate-800 dark:bg-slate-950/88 md:block">
