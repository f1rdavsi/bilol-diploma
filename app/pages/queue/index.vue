...
<template>
  <section class="space-y-5">
    ...
    <DataTable :columns="[{ key: 'queuePosition', label: 'Позиция' }, { key: 'client', label: 'Клиент' }, { key: 'car', label: 'Авто' }, { key: 'status', label: 'Статус' }, { key: 'employee', label: 'Механик' }]" :rows="store.items as any" :loading="store.loading">
