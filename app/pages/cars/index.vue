  ...
  <section class="space-y-5">
    <div class="flex flex-col justify-between gap-3 md:flex-row md:items-end">
      <div>
        ...
        <p class="page-muted">Автомобили клиентов и история обслуживания. Всего записей: {{ store.total }}</p>
      </div>
    ...
    <Modal :open="formOpen" :title="form.id ? 'Редактировать автомобиль' : 'Новый автомобиль'" size="lg" @close="closeForm">
